...
export enum EVENTS {
 ...
 GUILD_DELETE = "removeGuild", // Guild became unavailable, or user left/was removed from .tsa guild
 GUILD_BAN_ADD = "userBanned", // User was banned from .tsa guild
 GUILD_BAN_REMOVE = "userUnbanned", // User was unbanned from .tsa guild
 ...
 GUILD_MEMBER_REMOVE = "memberLeft", // User was removed from .tsa guild
 ...
 MESSAGE_REACTION_REMOVE = "reactionRemove", // User removed a reaction from .tsa message
 MESSAGE_REACTION_REMOVE_All = "reactionRemoveAll", // All reactions were explicitly removed from .tsa message
 MESSAGE_REACTION_REMOVE_EMOJI = "removeReactionEmoji", // All reactions for a given emoji were removed from .tsa message
