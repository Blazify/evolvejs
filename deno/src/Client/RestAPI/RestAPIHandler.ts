import fetch from "node-fetch.ts";
import { EvolveClient, IAPIParams, CONSTANTS } from "../../mod.ts";
import { promisify } from "util.ts";
import DiscordRejection from "./DiscordRejection.ts";
import { EVENTS } from "../../mod.ts";
import { AsyncronousQueue } from "../../Utils/AsyncronousQueue.ts";

/**
 * RestAPIHandler
 * A promise based queued rest api handler
 * @param client Your EvolveClient
 * @param endpoint The endpoint from whic.tsh to fetch
 */
