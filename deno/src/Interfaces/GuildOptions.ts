...
import { IEmoji } from "./EmojiOptions.ts";
import { IRole } from "./RoleOptions.ts";
import { IVoiceState } from "./VoiceStateOptions.ts";
import { IGuildMember } from "./GuildMemberOptions.ts";
import { IPresenceUpdate } from "./PresenceUpdateOptions.ts";
...
export interface IGuild {
 ...
 widget_channel_id?: string; // The channel ID that the widget will generate an invite to
 system_channel_id?: string; // The ID of the system channel
 system_channel_flags: number; // System channel flags
 rules_channel_id?: string; // The ID of the rule channel of guilds with the "PUBLIC" feature
 ...
 public_updates_channel_id?: string; // Where of guilds with the "PUBLIC" feature receive notices from Discord.ts
